    ...
    <>
      ...
      <Content>
        <Text>
          ...
          <Description>
            Para criar uma conta, é necessário inscrever-se numa instituição de
            ensino médio ou superior. Assim, os próximos passos serão explorar e
            escolher uma instituição de ensino e, em seguida, realizar a
            inscrição tanto na instituição escolhida quanto na plataforma. Vamos
            começar?
          </Description>
        </Text>
        <Btn>
