...
import Bg from "@/assets/backgrounds/candidato/exames-passados.png";
...
export default function MateriaisPreparatorioPage() {
  ...
  const mockData: MateriaisData = {
    ...
    materials: [
      ...
      {
        id: "2",
        title: "ENGTECA - Exame de acesso 2023",
        subject: "2023",
        icon: "science",
      ...
      {
        id: "3",
        title: "ENGTECA - Exame de acesso 2022",
        subject: "Programação",
        icon: "code",
      ...
      {
        id: "4",
        title: "ENGTECA - Exame de acesso 2021",
        subject: "Matemática",
        icon: "book",
  ...
  return (
    <>
      <Container>
        ...
        <SectionHeader>
          <SectionTitle>Selecione o material</SectionTitle>
